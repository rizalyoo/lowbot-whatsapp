...
//
const BotName = 'LOW BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/rizalyoo_'; // Nama Instagramlu cok
const whatsapplu = '0812-3168-7283'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => BOT BY @rizalyoo_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => BOT BY @rizalyoo_`)
})
